...
export const ConnectAccount = ({ changeAddress }) => {
    let { id } = useParams()
                    ...
                    {WALLET.map(
                        (item, index) =>
                            item.id === parseInt(id) && (
                                <div
                                    key={index}
                                    className="flex flex-col  space-y-3  text-left text-white bg-gray-secandary px-3 lg:px-8 2xl:px-10 py-4  border border-border-card">
                                    ...
                                    <div className="flex items-center space-x-3 py-4 text-sm justify-between">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex items-center space-x-2 md:space-x-3 text-xs">
                                                <div className="underline text-gray-light cursor-pointer">
                                                    View on Explorer
                                                </div>
                                                <div className="underline text-gray-light cursor-pointer">
                                                    Copy an Address
